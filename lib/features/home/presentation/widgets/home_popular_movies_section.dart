...
import 'package:movie_stream_app/features/home/presentation/widgets/home_popular_movie_card.dart';
    ...
    return Column(
      ...
      children: [
        Row(
          ...
          children: [
            Text('Popular Movies', style: AppTextStyles.bodyLarge),
